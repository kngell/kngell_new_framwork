<?php $this->start('head'); ?>
<!-------Costum-------->
<link href="<?= $this->asset('css/custom/client/home/promotions/promotions', 'css') ?? ''?>" rel="stylesheet"
    type="text/css">
<?php $this->end(); ?>
<?php $this->start('body'); ?>
<main id="main-site">
    ...
    <section class="container brands" id="brands">
        <div class="row m-0 py-5">
            <img src="/kngell/public/assets/img/1.png" alt="" class="img-fluid col-lg-2 col-md-4 col-6">
            <img src="/kngell/public/assets/img/2.png" alt="" class="img-fluid col-lg-2 col-md-4 col-6">
            <img src="/kngell/public/assets/img/3.png" alt="" class="img-fluid col-lg-2 col-md-4 col-sm-6">
            <img src="/kngell/public/assets/img/4.png" alt="" class="img-fluid col-lg-2 col-md-4 col-sm-6">
            <img src="/kngell/public/assets/img/5.png" alt="" class="img-fluid col-lg-2 col-md-4 col-sm-6">
            <img src="/kngell/public/assets/img/6.png" alt="" class="img-fluid col-lg-2 col-md-4 col-sm-6">
        </div>
    </section>
    <section class="new-arrivals w-100" id="new-arrivals">
        <div class="row p-0 m-0">
            <div class="arrival-item col-lg-4 col-md-12 col-12 p-0">
                <img src="<?=ImageManager::asset_img('arrivals/1.jpg')?>" alt="" class="img-fluid">
            ...
            <div class="arrival-item col-lg-4 col-md-12 col-12 p-0">
                <img src="<?=ImageManager::asset_img('arrivals/5.jpg')?>" alt="" class="img-fluid">
                <div class="arrival-item__details">
            ...
            <div class="arrival-item col-lg-4 col-md-12 col-12 p-0">
                <img src="<?=ImageManager::asset_img('arrivals/3.jpg')?>" alt="" class="img-fluid">
                <div class="arrival-item__details">
...
<!----------custom--------->
<script type="text/javascript" src="<?= $this->asset('js/custom/client/home/promotions/promotions', 'js') ?? ''?>">
</script>
<?php $this->end();
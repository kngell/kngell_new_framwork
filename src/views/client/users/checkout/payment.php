<?php $this->start('head'); ?>
<!-------Costum-------->
<link href="<?= $this->asset('css/custom/client/users/account/payment', 'css') ?? ''?>" rel="stylesheet"
    type="text/css">
<?php $this->end(); ?>
<?php $this->start('body'); ?>
<main id="main-site">
                ...
                <div class="flex item justify-content-between">
                    <div class="">
                        <div class="img text-center">
                            <img src="<?=ImageManager::asset_img('payment/prod1')?>" alt="">
                        </div>
                        <div class="title">
...
<!----------custom--------->
<script type="text/javascript" src="<?= $this->asset('js/custom/client/users/account/payment', 'js') ?? ''?>">
</script>
<?php $this->end();